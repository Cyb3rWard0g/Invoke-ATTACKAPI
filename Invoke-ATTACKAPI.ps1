    ...
    {       
        If($PSCmdlet.ParameterSetName -eq 'SyncATTCK')
        {
            ...
            foreach ($cat in $categories)
            {
                ...
                if ($cat -eq 'Tactic'){$LookUpQuery = "[[Category:$cat]]|?Has description#-ia|?Citation reference|limit=9999"}
                ...
                elseif ($cat -eq 'Group'){$LookUpQuery = "[[Category:$cat]]|?Has ID|?Has alias|?Has description#-ia|?Has display name|?Has link text|?Has technique|?Uses software|?Citation reference|?Has URL|limit=9999"}
                elseif ($cat -eq 'Software'){$LookUpQuery = "[[Category:$cat]]|?Has ID|?Has alias|?Has description#-ia|?Has display name|?Has link text|?Has software type|?Has technique|?Citation reference|limit=9999"}
                ...
                elseif ($cat -eq 'Techniques subobjects'){$LookUpQuery = "[[Has technique object::+]]|?Has technique description#-ia|?Has technique object|limit=9999"}
